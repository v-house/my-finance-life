          ...
          <div className="flex items-center justify-evenly py-2 lg:py-4">
            <Link href="/" legacyBehavior>
              <a className="mx-auto flex justify-evenly items-center space-x-4 hover:text-white">
                ...
                <div>
                  <div className="text-xl font-medium text-white">Blogs</div>
                  <p className="text-slate-300">What we write</p>
                </div>
              </a>
            </Link>
            <Link href="/about" legacyBehavior>
              <a className="mx-auto flex items-center space-x-4 hover:text-white">
                ...
                <div>
                  <div className="text-xl font-medium text-white">About</div>
                  <p className="text-slate-300">Who we are</p>
                </div>
              </a>
            </Link>
          </div>
